...
scale(key_scale) difference()
{
    ...
    { 
        key();
			...
			rotate([0,0,45])
			{
				translate([-0.5,-11.3,-0.75]) cube([1,9,0.75], center=false);
				translate([-0.5,2.7,-0.75])  cube([1,8.5,0.75], center=false);
				translate([2.7,-0.5,-0.75])  cube([8.5,1,0.75], center=false);
				translate([-11.3,-0.5,-0.75]) cube([9,1,0.75], center=false);
			}
			translate([-0.5,-8.5,-0.75]) cube([1,6.5,0.75], center=false);
			translate([-0.5,2,-0.75])  cube([1,6.5,0.75], center=false);
			translate([2,-0.5,-0.75])  cube([6.5,1,0.75], center=false);
			translate([-8.5,-0.5,-0.75]) cube([6.5,1,0.75], center=false);		
			//roof
